...
class AlertEscalation(Base):
    ...
    from_level: Mapped[int] = mapped_column(Integer, default=1)  # 1: Planner, 2: SCM Manager, 3: VP Supply Chain
    to_level: Mapped[int] = mapped_column(Integer, default=2)
    ...
    status: Mapped[str] = mapped_column(String(30), default="PENDING")  # PENDING, IN_PROGRESS, RESOLVED, BREACHED
